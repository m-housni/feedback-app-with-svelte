    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			span = element("span");
    			t = text(/*error*/ ctx[1]);
    			attr_dev(span, "class", "error-badge svelte-5ys3vm");
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "class", "svelte-5ys3vm");
    			add_location(input, file$1, 51, 4, 1022);
    			attr_dev(button, "type", "submit");
    			button.disabled = /*btnDisabled*/ ctx[0];
    			attr_dev(button, "class", "svelte-5ys3vm");
    			add_location(button, file$1, 52, 4, 1106);
    			attr_dev(div, "class", "input-group text-center svelte-5ys3vm");
    			add_location(div, file$1, 50, 2, 979);
    			attr_dev(form, "class", "svelte-5ys3vm");
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 42, 0, 722);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},

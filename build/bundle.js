...
var app = (function () {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "card svelte-1rtk8d0");
    ...
    function create_default_slot(ctx) {
    	...
    	let t4;
    	let div2;
    	let t5_value = /*fb*/ ctx[0].text + "";
    	let t5;
    	let t6;
    	let br;
    	let t7;
    	let t8_value = /*fb*/ ctx[0].id + "";
    	let t8;
    	let mounted;
    	let dispose;
    	...
    	const block = {
    		c: function create() {
    			...
    			t7 = text("\r\n    id: ");
    			t8 = text(t8_value);
    			set_style(sub, "font-size", ".8rem");
    			add_location(sub, file$4, 14, 15, 317);
    			attr_dev(div0, "class", "num-display svelte-1yamtbo");
    			add_location(div0, file$4, 13, 2, 275);
    			attr_dev(div1, "class", "close svelte-1yamtbo");
    			add_location(div1, file$4, 16, 2, 369);
    			add_location(br, file$4, 19, 4, 483);
    			attr_dev(div2, "class", "text-display");
    			add_location(div2, file$4, 17, 2, 436);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*fb*/ 1 && t5_value !== (t5_value = /*fb*/ ctx[0].text + "")) set_data_dev(t5, t5_value);
    			if (dirty & /*fb*/ 1 && t8_value !== (t8_value = /*fb*/ ctx[0].id + "")) set_data_dev(t8, t8_value);
    		},
    		d: function destroy(detaching) {
    ...
    class FeedbackItem extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { fb: 0 });
    ...
    function create_if_block$1(ctx) {
    	...
    	let t0;
    	let t1;
    	let t2_value = (/*count*/ ctx[2] == 1 ? 'review' : 'reviews') + "";
    	let t2;
    	let t3;
    	let div1;
    	let span1;
    	let t4;
    	let t5_value = /*avg*/ ctx[1].rating / /*count*/ ctx[2] + "";
    	let t5;
    	let t6;
    	...
    	const block = {
    		c: function create() {
    			...
    			div1 = element("div");
    			span1 = element("span");
    			t4 = text("Rating Everage: ");
    			t5 = text(t5_value);
    			t6 = text("/10");
    			attr_dev(span0, "class", "badge svelte-rczt9e");
    			add_location(span0, file$3, 18, 6, 461);
    			attr_dev(div0, "class", "float-left");
    			add_location(div0, file$3, 17, 4, 429);
    			attr_dev(span1, "class", "badge svelte-rczt9e");
    			add_location(span1, file$3, 21, 6, 582);
    			attr_dev(div1, "class", "float-right");
    			add_location(div1, file$3, 20, 4, 549);
    			attr_dev(div2, "class", "space-around svelte-rczt9e");
    			set_style(div2, "font-weight", "bold");
    			add_location(div2, file$3, 16, 2, 372);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div2, anchor);
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*count*/ 4 && t2_value !== (t2_value = (/*count*/ ctx[2] == 1 ? 'review' : 'reviews') + "")) set_data_dev(t2, t2_value);
    			if (dirty & /*avg, count*/ 6 && t5_value !== (t5_value = /*avg*/ ctx[1].rating / /*count*/ ctx[2] + "")) set_data_dev(t5, t5_value);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div2);
    		}
    ...
    // (27:2) {#each feedback as fb (fb.id)}
    function create_each_block$1(key_1, ctx) {
    	...
    	feedbackitem.$on("delete-feedback", /*delete_feedback_handler*/ ctx[3]);
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			t = space();
    			add_location(div, file$3, 27, 4, 721);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*feedback*/ 1) feedbackitem_changes.fb = /*fb*/ ctx[4];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(27:2) {#each feedback as fb (fb.id)}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$3, 13, 0, 344);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		...
    		if ($$self.$$.dirty & /*feedback*/ 1) {
    			$$invalidate(1, avg = feedback.length
    			? feedback.reduce((prev, cur) => {
    					return { rating: prev.rating + cur.rating };
    				})
    			: {});
    		}
    	};

    	return [feedback, avg, count, delete_feedback_handler];
    }

    class FeedbackList extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { feedback: 0 });
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			span = element("span");
    			t = text(/*error*/ ctx[1]);
    			attr_dev(span, "class", "error-badge svelte-6u5ts5");
    			add_location(span, file$1, 64, 4, 1695);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			input.value = /*text*/ ctx[2];
    			attr_dev(input, "placeholder", "Feedback");
    			attr_dev(input, "class", "svelte-6u5ts5");
    			add_location(input, file$1, 60, 4, 1522);
    			attr_dev(button, "type", "submit");
    			button.disabled = /*btnDisabled*/ ctx[0];
    			attr_dev(button, "class", "svelte-6u5ts5");
    			add_location(button, file$1, 61, 4, 1606);
    			attr_dev(div, "class", "input-group text-center svelte-6u5ts5");
    			add_location(div, file$1, 59, 2, 1479);
    			attr_dev(form, "class", "svelte-6u5ts5");
    			add_location(form, file$1, 57, 0, 1377);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (!current || dirty & /*text*/ 4 && input.value !== /*text*/ ctx[2]) {
    				prop_dev(input, "value", /*text*/ ctx[2]);
    			}

    			if (!current || dirty & /*btnDisabled*/ 1) {
    				prop_dev(button, "disabled", /*btnDisabled*/ ctx[0]);
    			}
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const handleInput = e => {
    		...
    		if (ln >= min) {
    			...
    			$$invalidate(1, error = 'Min ' + min + ' chars');
    		}
    	};
    	...
    	const handleSubmit = () => {
    		...
    		// new feedback
    		const newFeedback = { id: uuid_1.v4(), text, rating: +rating };
    	...
    	return [btnDisabled, error, text, handleInput, handleSelect, handleSubmit];
    }
    ...
    function create_fragment(ctx) {
    	...
    	feedbackform.$on("new-feedback", /*handleNewFeedback*/ ctx[2]);
    	...
    	feedbacklist.$on("delete-feedback", /*deleteFeedback*/ ctx[1]);
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(main, "class", "container svelte-19rxjep");
    			add_location(main, file, 54, 0, 1250);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const deleteFeedback = e => {
    		...
    		$$invalidate(0, feedback = feedback.filter(fb => {
    			return fb.id != fbId;
    		}));
    	};
      ...
      // output: [0,1,2,12]
    */
    		$$invalidate(0, feedback = [e.detail, ...feedback]);
    	};
    	...
    	$$invalidate(0, feedback = [
    		...
    		{ id: 1, rating: 5, text: "rating text 1" },
    		{ id: 2, rating: 6, text: "rating text 2" },
    		{ id: 3, rating: 7, text: "rating text 3" },
    		{ id: 4, rating: 7, text: "rating text 4" }
    	]);

    	return [feedback, deleteFeedback, handleNewFeedback];
    }

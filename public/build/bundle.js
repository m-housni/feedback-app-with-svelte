    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$1, 55, 4, 1195);
    		},
    		m: function mount(target, anchor) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const handleInput = e => {
    		...
    		if (ln >= 10) {
    			...
    			$$invalidate(1, error = 'Min 10 chars');
    		}
    	};
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(main, "class", "container svelte-8arma1");

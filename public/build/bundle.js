    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(sub, file$4, 15, 15, 314);
    			attr_dev(div0, "class", "num-display svelte-1v7eqe6");
    			add_location(div0, file$4, 14, 2, 272);
    			attr_dev(div1, "class", "close svelte-1v7eqe6");
    			add_location(div1, file$4, 17, 2, 366);
    			attr_dev(div2, "class", "text-display");
    			add_location(div2, file$4, 20, 2, 443);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 55, 0, 1237);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
